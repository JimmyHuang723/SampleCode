                ...
                <form class="form-inline" method="post" action="{{url('/progressnote/search_result/'.$resident->_id)}}" >
                    ...
                    <div class="form-group">
                        <div class='input-group '>
                            <input type='text' class="form-control" value="{{$request->notes}}"  id="notes"  name="notes" placeholder="Search notes.." />
                    ...
                    <div class="form-group">
                        <div class='input-group date' id='date_start'>
                            <input  type='text' class="form-control"  id="datepicker"  value="{{$request->date_start}}" name="date_start" placeholder="Start Date" />
                    ...
                    <div class="form-group">
                        <div class='input-group date' id='date_end'>
                            <input  type='text' class="form-control" id="datepicker" value="{{$request->date_end}}" name="date_end" placeholder="End Date" />
                            <span class="input-group-addon">
                                <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                        </div>
                    ...
                    <div class="form-group">
                        <div class='input-group date' id='user'>
                            <input type='text' class="form-control" name="fullname" value="{{$request->fullname}}" placeholder="User (Optional)" />
                            <span class="input-group-addon">
