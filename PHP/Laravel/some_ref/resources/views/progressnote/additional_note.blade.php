    ...
    <div class="container container-top">
        ...
        <div class="columns">
            ...
            <div class="column is-6">
                <div class="block">
                    <h2 class="subtitle">{{strip_tags($pnotes->notes)}} note</h2>

                </div>
                <form method="post" action="{{url('/progressnote/additional_note/'.$pnotes->_id)}}">
                    ...
                    <input type="hidden" name="pnId" value="{{$pnotes->_id}}"/>
            ...
            {{--<div class="column is-6">--}}
                {{--<div class="block">--}}
                    {{--<h2 class="subtitle">{{__('mycare.last_5_additional_progressnotes')}}</h2>--}}
                {{--</div>--}}
