...
angular.module('myApp.roomAdmin', ['ngRoute','ui.materialize'])
    ...
    .controller('RoomAdminCtrl', function($scope,$http,$location) {
      ...
      $scope.init = function(){
        $http.get('/hotel-booking/public/adminapi/room_type').success(function(data){
      ...
      $scope.create = function(){
        $http.post('/hotel-booking/public/adminapi/room_type',$scope.new_type).success(function(data){
      ...
      $scope.setprice = function(){
        ...
        $http.post('/hotel-booking/public/adminapi/setpriceinrange',$scope.update_data).success(function(data){
